# extractors/spinempire_extractor.py
...
class SpinEmpireExtractor(BaseExtractor):
    ...
    def get_payment_and_withdraw_systems(self, current_geo: str) -> Tuple[
        ...
        logging.info("[SpinEmpire] Fetching DEPOSIT methods")
        dep_titles, dep_names, rec_dep, dep_raw = self.fetch_methods(
            self.DEPOSIT_URL, country, return_raw=True
        )

        logging.info("[SpinEmpire] Fetching WITHDRAW methods")
